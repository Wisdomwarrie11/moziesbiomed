          ...
          <div className="grid md:grid-cols-4 gap-16 mb-24">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <a href="#" className="w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center hover:bg-red-600 transition-all text-white" aria-label="Instagram">
                ...
                <a href="#" className="w-10 h-10 bg-gray-900 rounded-full flex items-center justify-center hover:bg-red-600 transition-all text-white" aria-label="YouTube">
